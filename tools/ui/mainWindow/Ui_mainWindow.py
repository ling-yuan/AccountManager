...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionQRcode = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./img/qrcode.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQRcode.setIcon(icon3)
        self.actionQRcode.setObjectName("actionQRcode")
        ...
        self.menu_3.addAction(self.actionQRcode)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionQRcode.setText(_translate("MainWindow", "识别二维码"))
